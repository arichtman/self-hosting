...
DOCKER_SUBNET_CIDR=$(docker network inspect bridge --format "{{ json .IPAM.Config }}" | jq -r .[].Subnet )

# Traefik & TLS Configuration
TRAEFIK_DOCKER_IMAGE=${PRIVATE_TRAEFIK_DOCKER_IMAGE:=traefik:v2.4.8}
...
HYDROXIDE_IMAGE_NAME=${PRIVATE_HYDROXIDE_IMAGE_NAME:=protonmail-bridge}
HYDROXIDE_VERSION=${PRIVATE_HYDROXIDE_VERSION:=0.2.18}
HYDROXIDE_USER=${PRIVATE_HYDROXIDE_USER:=someuser@protonmail.com}
HYDROXIDE_PASSWORD=${PRIVATE_HYDROXIDE_PASSWORD:=someuser}

# HYDROXIDE_DEBUG=true
# HYDROXIDE_INTERPOD=true