...
NEXTCLOUD_DOCKER_IMAGE={$PRIVATE_NEXTCLOUD_DOCKER_IMAGE:=nextcloud:18}
...
NEXTCLOUD_POSTGRES_DOCKER_IMAGE={$PRIVATE_NEXTCLOUD_POSTGRES_DOCKER_IMAGE:=postgres:9.6}
